...
import com.capgemini.assignment3.oops.BankAccount;
...
class BankAccountTest {
	...
	void setUp()
	{
		account = new BankAccount(1234, "Shubham ","SAVINGS",50000);
	}
	@Test
	void testWithdraw() {
	...
	void testTotalBankAccounts() {
		...
		BankAccount account1 = new BankAccount(3456, "Shweta", "SAVING", 34000);
